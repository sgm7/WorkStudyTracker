...
public class WorkStudyTrackingUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        hsuIDLabel = new javax.swing.JLabel();
        ...
        awardAmountLabel = new javax.swing.JLabel();
        studentName = new javax.swing.JTextField();
        studentNameLabel = new javax.swing.JLabel();
        disbursementListPane = new javax.swing.JScrollPane();
        editButton = new EnterButton("editButton");
        deleteButton = new EnterButton("deleteButton");
        exitButton = new EnterButton("exitButton");
        submitButton = new EnterButton("submitButton");
    ...
    private class IDBoxAction implements ActionListener {
      public void actionPerformed (ActionEvent evt) {
         ...
         */
        if (visCount == invisCount && oldSelectedItem == newSelectedItem) {
    ...
    private Boolean validateInput() {
      if(department.getValue() != null && itemType.getValue() != null && 
         amount.getValue() != null && period.getValue() != null && 
         term.getValue() != null) {return true;}
      else {return false;}
    }
    ...
    private void populateSummaryTable() {
      ...
      summaryTable = new JTable(summaryTableRows, summaryTableColumns) {
    ...
    private javax.swing.JLabel awardAmountLabel;
    private EnterButton clearButton;
    private javax.swing.JPanel dataEntryTab;
    private EnterButton deleteButton;
    ...
    private EnterButton exitButton;
    private javax.swing.JComboBox hsuID;
    private javax.swing.JLabel hsuIDLabel;
    ...
    private EnterButton submitButton;
